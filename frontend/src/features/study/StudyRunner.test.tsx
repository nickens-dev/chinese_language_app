...
test("shows session scores and direction-specific card history on completion", () => {
  const completed: StudySession = {
    ...
    currentPrompt: null,
    summary: {
      correctCount: 1, mostlyCorrectCount: 0, incorrectCount: 0,
      overriddenCount: 0, correctPercent: 100, averageScore: 96,
      results: [{
