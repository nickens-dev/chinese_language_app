...
interface ProgressPageProps { decks: DeckSummary[]; onStudy: () => void; }
const modes = [
...
export function ProgressPage({ decks, onStudy }: ProgressPageProps) {
  ...
  return <section className="page progress-page">
    <div className="page-heading"><div><p className="kicker">Learning history</p><h1>Progress</h1><p>See where practice is working and which words or study directions need attention.</p></div><button className="primary-button" type="button" onClick={onStudy}>Start study session</button></div>
